...
SEG_DIR=./scripts/demo/$MODE/output_seg
OUTPUT=./scripts/demo/$MODE/output_normal

#--------------------------MODEL CARD---------------
# MODEL_NAME='sapiens_0.3b'; CHECKPOINT=./scripts/demo/$MODE/checkpoints/sapiens_0.3b_normal_render_people_epoch_66_$MODE.pt2
# MODEL_NAME='sapiens_0.6b'; CHECKPOINT=./scripts/demo/$MODE/checkpoints/sapiens_0.6b_normal_render_people_epoch_200_$MODE.pt2
MODEL_NAME='sapiens_1b'; CHECKPOINT=./scripts/demo/$MODE/checkpoints/sapiens_1b_normal_render_people_epoch_115_$MODE.pt2
# MODEL_NAME='sapiens_2b'; CHECKPOINT=./scripts/demo/$MODE/checkpoints/sapiens_2b_normal_render_people_epoch_70_$MODE.pt2
