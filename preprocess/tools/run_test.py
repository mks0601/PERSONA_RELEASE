...
if (result != 0):
    print('something bad happened when making virtual camera parameters (run_test.py). terminate the script.')
    sys.exit()
...
result = os.system(cmd)
if (result != 0):
    print('something bad happened when running Hand4Whole (run_test.py). terminate the script.')
    sys.exit()
os.chdir(cur_path)
