...
OUTPUT=./scripts/demo/$MODE/output_depth

#--------------------------MODEL CARD---------------
# MODEL_NAME='sapiens_0.3b'; CHECKPOINT=./scripts/demo/$MODE/checkpoints/sapiens_0.3b_render_people_epoch_100_$MODE.pt2
# MODEL_NAME='sapiens_0.6b'; CHECKPOINT=./scripts/demo/$MODE/checkpoints/sapiens_0.6b_render_people_epoch_70_$MODE.pt2
MODEL_NAME='sapiens_1b'; CHECKPOINT=./scripts/demo/$MODE/checkpoints/sapiens_1b_render_people_epoch_88_$MODE.pt2
# MODEL_NAME='sapiens_2b'; CHECKPOINT=./scripts/demo/$MODE/checkpoints/sapiens_2b_render_people_epoch_25_$MODE.pt2
